...
export class AIController {
  ...
  async generateName(
    c: Context,
    data: { ingredients: string[]; instructions: string[]; category?: string }
  ) {
    try {
      ...
      throw new HTTPException(500, {
        message: "An error occurred while generating the recipe name",
      });
    }
  }
  ...
  async generateDescription(
    ...
    try {
      ...
      throw new HTTPException(500, {
        message: "An error occurred while generating the recipe description",
      });
    }
  }
}
