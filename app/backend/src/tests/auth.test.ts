...
afterAll(async () => {
  // Clean up test user
  try {
    await db.delete(schema.users).where(schema.users.username.equals(testUser.username));
  } catch (error) {
...
describe('Authentication', () => {
  ...
  it('should register a new user', async () => {
    ...
    await db.delete(schema.users).where(schema.users.username.equals(uniqueUsername));
  });
